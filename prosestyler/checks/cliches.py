...
class Cliches(BaseCheck):
    ...
    def _check_sent(self, sentence, ignore_list=None):
        ...
        lem = " ".join(
            [
                x[0] if not x[1].startswith("PRP") else "prp"
                for x in sentence.lemmas
            ]
        ).lower()

        regex = rf" [{punctuation}] "
        lem = re.sub(regex, r" ", lem)
...
CLICHES = {
    ...
    "as luck would have prp": [],
    "as old as time": [],
    "as the crow fly": ["directly", "immediately", "straight"],
    ...
    "avoid prp like the plague": ["avoid"],
    "babe in the wood": [],
    ...
    "back to square one": [],
    "back to the drawing board": ["beginning", "origin", "outset", "start"],
    "bad blood": [
        "acrimony",
        "animosity",
        "animus",
    ...
    "bird's eye view": [],
    "bit off more than prp can chew": [],
    ...
    "good thing since slice bread": ["delight", "pleasure"],
    ...
    "hear a pin drop": [],
    "hear prp through the grapevine": [],
    "heart break": [],
    "heart breaker": [],
    ...
    "make the good of a bad situation": [],
    "make the good of prp": [],
    "make up": [
        "complete",
        "compose",
        "comprise",
    ...
    "needless to say": ["clearly", "consequently", "naturally", "obviously"],
    ...
    "plain as day": [],
    "plain as the nose on prp face": ["apparent"],
    "play by the rule": [],
    ...
    "reap what prp sow": [],
    "red as a beet": [],
    "red carpet treatment": ["greeting", "reception", "welcome"],
    ...
    "regard the matter of": ["regarding"],
    "reinvent the wheel": [],
    ...
    "this hurt prp more than prp hurt prp": [],
    "this point in time": [],
    ...
    "vain effort": [],
    "vanquish the enemy": [],
    "various and sundry": ["sundry"],
    "vested interest": [],
    "viable alternative": [],
    "wake up call": [],
    "wakeup call": [],
    "warm welcome": [],
    "wash up": ["defeated", "ruined", "clean"],
    ...
    "when the cat's away": [],
    "when the going get tough the tough get go": [],
    "whet prp appetite": [],
    "white as a sheet": [],
    "whole ball of wax": [
        "aggregate",
